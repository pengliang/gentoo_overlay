...
src_install() {
	...
	einfo "To start utorrent-server type: /usr/share/${PN}/bin/utserver"
	...
	einfo "uTorrent uses webui from current directory, by default, so be
	careful! Config it first! You can find webui.zip in
	/usr/share/${PN}/webui/"
}
